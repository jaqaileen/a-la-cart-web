...
(function(h) {
    var x, y = "", G = Math.PI, E = G / 2, q = "Touch"in window, I = q ? {
        start: "touchstart",
        move: "touchmove",
        end: "touchend"
    } : {
        ...
        init: function(a) {
            void 0 === x && (x = "WebKitCSSMatrix"in window || "MozPerspective"in document.body.style,
            y = R());
            var b, c = this.data(), d = this.children(), a = h.extend({
                width: this.width(),
                height: this.height()
            }, P, a);
            c.opts = a;
        ...
        addPage: function(a, b) {
            ...
            if (b)
                if (b == e)
                    ...
                    if (b > e)
                        throw Error('It is impossible to add the page "' + b + '", the maximum value is: "' + e + '"');
                }
            else
                b = e,
                c = !0;
        ...
        range: function(a) {
            var b, c, d = this.data(), a = a || d.tpage || d.page, e = g._view.call(this, a);
            if (1 > a || a > d.totalPages)
                throw Error('"' + a + '" is not a page for range');
            e[1] = e[1] || e[0];
            1 <= e[0] && e[1] <= d.totalPages ? (a = Math.floor(2),
            d.totalPages - e[1] > e[0] ? (b = Math.min(e[0] - 1, a),
            c = 2 * a - b) : (c = Math.min(d.totalPages - e[1], a),
            b = 2 * a - c)) : c = b = 5;
        ...
        _movePages: function(a, b) {
            var c, d = this.data(), e = "single" == d.display, f = function(a) {
                var c = a + b
                  , f = c % 2;
                d.pageObjs[a] && (d.pageObjs[c] = d.pageObjs[a].removeClass("page" + a).addClass("page" + c));
                d.pagePlace[a] && d.pageWrap[a] && (d.pagePlace[c] = c,
                d.pageWrap[c] = d.pageWrap[a].css(K[e ? 0 : f]).attr("page", c),
                d.pages[a] && (d.pages[c] = d.pages[a].flip("options", {
                    page: c,
                    next: e || f ? c + 1 : c - 1,
        ...
        size: function(a, b) {
            if (a && b) {
                var c = this.data(), d = "double" == c.display ? a / 2 : a, e;
                this.css({
                    width: a,
                    height: b
                });
        ...
        stop: function() {
            var a, b, c = this.data(), d = c.pageMv;
            c.pageMv = [];
            c.tpage && (c.page = c.tpage,
            delete c.tpage);
            for (a in d)
                p(a, d) && (b = c.pages[d[a]].data().f.opts,
                i._moveFoldingPage.call(c.pages[d[a]], null),
                c.pages[d[a]].flip("hideFoldedPage"),
                c.pagePlace[b.next] = b.next,
                b.force && (b.next = 0 === b.page % 2 ? b.page - 1 : b.page + 1,
                delete b.force));
            this.turn("update");
            return this
        },
        ...
        _turnPage: function(a) {
            var b, c, d = this.data(), e = this.turn("view"), f = this.turn("view", a);
            d.page != a && (this.trigger("turning", [a, f]),
            -1 != h.inArray(1, f) && this.trigger("first"),
            -1 != h.inArray(d.totalPages, f) && this.trigger("last"));
            if (d.pageObjs[a] && (d.tpage = a,
            this.turn("stop"),
            g._makeRange.call(this),
            "single" == d.display ? (b = e[0],
            c = f[0]) : e[1] && a > e[1] ? (b = e[1],
            c = f[0]) : e[0] && a < e[0] && (b = e[0],
            c = f[1]),
            d.pages[b]))
                a = d.pages[b].data().f.opts,
                d.tpage = c,
                a.next != c && (a.next = c,
                d.pagePlace[c] = a.page,
                a.force = !0),
        ...
        page: function(a) {
            var a = parseInt(a, 10)
              , b = this.data();
            return 0 < a && a <= b.totalPages ? (!b.done || -1 != h.inArray(a, this.turn("view")) ? g._fitPage.call(this, a) : g._turnPage.call(this, a),
            this) : b.page
        },
        next: function() {
            var a = this.data();
        ...
        _start: function(a, b, c) {
            ...
            e.isDefaultPrevented() ? a.preventDefault() : ("single" == d.display && (c = "l" == c.charAt(1),
            1 == b.page && c || b.page == d.totalPages && !c ? a.preventDefault() : c ? (b.next = b.next < b.page ? b.next : b.page - 1,
        ...
        _pressed: function() {
            var a, b = h(this).data().f, c = b.opts.turn.data().pages;
            for (a in c)
        ...
        calculateZ: function(a) {
            var b, c, d, e, f = this, i = this.data();
            b = this.turn("view");
            var h = b[0] || b[1]
              , g = {
                pageZ: {},
        ...
        update: function() {
            ...
            if (b.pageMv.length && 0 !== b.pageMv[0]) {
                ...
                for (a in b.pageWrap)
                    ...
                    b.pages[a] && (b.pages[a].flip("z", c.partZ[a] || null),
                    c.pageV[a] && b.pages[a].flip("resize"),
                    b.tpage && b.pages[a].flip("disable", !0)))
            } else
                for (a in b.pageWrap)
                    p(a, b.pageWrap) && (c = g._setPageLoc.call(this, a),
        ...
        _addPageWrapper: function() {
            ...
            if (!a.wrapper) {
                ...
                c.data().flips = 0,
                a.opts.turn ? (c.css(l(-a.opts.turn.offset().top, -a.opts.turn.offset().left, "auto", "visible").css).appendTo(a.opts.turn),
                a.opts.turn.data().fparent = c) : c.css(l(0, 0, "auto", "visible").css).attr("id", "turn-fwrappers").appendTo(h("body")),
                a.fparent = c);
                this.css({
                    position: "absolute",
                    top: 0,
        ...
        _fold: function(a) {
            var b = this, c = 0, d = 0, e, f, h, g, v, H, n = j(0, 0), p = j(0, 0), k = j(0, 0), r = this.width(), u = this.height(), l = i._foldingPage.call(this);
            Math.tan(d);
            var o = this.data().f
              ...
              , F = function() {
                var m = j(q.x ? q.x - a.x : a.x, q.y ? q.y - a.y : a.y), B = Math.atan2(m.y, m.x), z;
                d = E - B;
                c = 180 * (d / G);
                ...
                if (d > E && (k.x += Math.abs(k.y * Math.tan(B)),
                k.y = 0,
                Math.round(k.x * Math.tan(G - d)) < u))
                    return a.y = Math.sqrt(Math.pow(u, 2) + 2 * z.x * m.x),
                    D && (a.y = u - a.y),
                    F();
                if (d > E && (m = G - d,
                B = y - u / Math.sin(m),
                ...
                H = m < r ? m / r : 1;
                if (o.opts.frontGradient && (g = 100 < v ? (v - 100) / v : 0,
                f = j(100 * (v * Math.sin(E - d) / u), 100 * (v * Math.cos(E - d) / r)),
                D && (f.y = 100 - f.y),
                A))
                    f.x = 100 - f.x;
                if (i._backGradient.call(b) && (h = j(100 * (v * Math.sin(d) / r), 100 * (v * Math.cos(d) / u)),
                A || (h.x = 100 - h.x),
                !D))
                    h.y = 100 - h.y;
                k.x = Math.round(k.x);
        ...
        _showFoldedPage: function(a, b) {
            ...
            if (c) {
                ...
                e.fwrapper.is(":visible") || (e.fparent.show().data().flips++,
        ...
        _eventStart: function(a) {
            ...
            if (!b.disabled && !this.flip("isTurning")) {
                ...
                if (b.corner && i._foldingPage.call(this, b.corner))
                    return i._moveFoldingPage.call(this, !0),
        ...
        _eventMove: function(a) {
            var b = this.data().f;
            if (!b.disabled)
                if (a = q ? a.originalEvent.touches : [a],
                b.corner) {
                    ...
                    !this.data().effect && this.is(":visible") && ((a = i._cornerActivated.call(this, a[0])) ? (b = i._c.call(this, a.corner, b.opts.cornerSize / 2),
                    a.x = b.x,
                    a.y = b.y,
                    i._showFoldedPage.call(this, a, !0)) : i.hideFoldedPage.call(this, !0))
        },
        _eventEnd: function() {
            var a = this.data().f;
    ...
    h.extend(h.fn, {
        ...
        animatef: function(a) {
            ...
            if (a) {
                ...
                var c, d = [], e = a.to.length, f = this, h = a.fps || 30, i = -h, g = function() {
                    var c, g = [];
                    i = Math.min(a.duration, i + h);
                    for (c = 0; c < e; c++)
                        g.push(a.easing(1, i, a.from[c], d[c], a.duration));
                    a.frame(e == 1 ? g[0] : g);
                    if (i == a.duration) {
